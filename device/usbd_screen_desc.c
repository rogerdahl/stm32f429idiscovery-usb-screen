...
#define USBD_PID                     	0x7777

#define USBD_LANGID_STRING            	0x409
#define USBD_MANUFACTURER_STRING      	(uint8_t*)"dahlsys.com"

#define USBD_PRODUCT_HS_STRING        	(uint8_t*)"USB screen (HS mode)"
#define USBD_SERIALNUMBER_HS_STRING   	(uint8_t*)"000000000001"

#define USBD_PRODUCT_FS_STRING        	(uint8_t*)"USB screen (FS mode)"
#define USBD_SERIALNUMBER_FS_STRING   	(uint8_t*)"000000000002"

#define USBD_CONFIGURATION_HS_STRING  	(uint8_t*)"Screen Config"
#define USBD_INTERFACE_HS_STRING      	(uint8_t*)"Screen Interface"

#define USBD_CONFIGURATION_FS_STRING  	(uint8_t*)"Screen Config"
#define USBD_INTERFACE_FS_STRING      	(uint8_t*)"Screen Interface"
/**
  * @}
  */ 
